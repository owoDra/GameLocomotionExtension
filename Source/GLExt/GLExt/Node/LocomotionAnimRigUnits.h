...
struct GLEXT_API FRigVMFunction_ExponentialDecayVector : public FRigVMFunction_SimBase
{
	GENERATED_BODY()
...
struct GLEXT_API FRigUnit_CalculatePoleVector : public FRigUnit
{
	GENERATED_BODY()
...
struct GLEXT_API FRigUnit_HandIkRetargeting : public FRigUnitMutable
{
	GENERATED_BODY()
