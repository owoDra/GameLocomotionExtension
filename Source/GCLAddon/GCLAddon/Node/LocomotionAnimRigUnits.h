...
#include "LocomotionAnimRigUnits.generated.h"


USTRUCT(DisplayName = "Exponential Decay (Vector)")
struct GCLADDON_API FRigVMFunction_ExponentialDecayVector : public FRigVMFunction_SimBase
{
	GENERATED_BODY()
 ...
 */
USTRUCT(DisplayName = "Calculate Pole Vector", Meta = (NodeColor = "0.05 0.25 0.05"))
struct GCLADDON_API FRigUnit_CalculatePoleVector : public FRigUnit
{
	GENERATED_BODY()
...
USTRUCT(DisplayName = "Hand Ik Retargeting", Meta = (NodeColor = "0 0.36 1.0"))
struct GCLADDON_API FRigUnit_HandIkRetargeting : public FRigUnitMutable
{
	GENERATED_BODY()
