...
#include "ViewAnimationState.generated.h"

USTRUCT(BlueprintType)
struct GCLADDON_API FLookState
{
	GENERATED_BODY()
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "", Meta = (ClampMin = -90, ClampMax = 90, ForceUnits = "deg"))
	float PitchAngle = 0.0f;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "", Meta = (ClampMin = 0, ClampMax = 1))
	float YawForwardAmount = 0.5f;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "", Meta = (ClampMin = 0, ClampMax = 0.5))
	float YawLeftAmount = 0.5f;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "", Meta = (ClampMin = 0.5, ClampMax = 1))
	float YawRightAmount = 0.5f;
};

USTRUCT(BlueprintType)
struct GCLADDON_API FSpineRotationState
{
	GENERATED_BODY()
public:
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "")
...
USTRUCT(BlueprintType)
struct GCLADDON_API FViewAnimationState
{
	GENERATED_BODY()
public:
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "")
